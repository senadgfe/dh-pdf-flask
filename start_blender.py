...
class Image_Textures: 
    ...
    melatonin_tee = r"C:\Shared\Work\GFE\dh-pdf-flask\static\uploads\annotated\90587310_FS_DH_Melatonin-Heissgetraenk_Btl_20-PDFX4_2_MV94x64x106.png"
    melatonin_intense = r"C:\Shared\Work\GFE\dh-pdf-flask\static\uploads\annotated\hl_90588160_FS_DH_Melatonin_1,8mg_40_Tbl-PDFX4_2_MV72x24x107.png"
    hals = r"C:\Shared\Work\GFE\dh-pdf-flask\static\uploads\annotated\hl_90587043_FS_DH_Halsschmerzen_Tbl_24-PDFX4_2_MV76x21x125.png"
    B12_Energie_Schmelztabletten = r"C:\Shared\Work\GFE\dh-pdf-flask\static\uploads\annotated\hl_90588056_FS_DH_B12_Energie_Schmelztabletten_Sofort_Tbl_30-PDFX4_2_MV85x25x122.png"
    

class pdfs:
    hals = r"C:\Shared\Work\GFE\dh-pdf-flask\static\uploads\90587043_FS_DH_Halsschmerzen_Tbl_24-PDFX4_2.pdf"
...
texture_path = Image_Textures.melatonin_intense
...
def generate_texture(inputfile, outputfolder):
    file = f"python3 app.py {inputfile} {outputfolder}"
    print(file)
